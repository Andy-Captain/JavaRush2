...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
                        ...
                        BufferedReader readerFileFirst = new BufferedReader(new FileReader(fileNameFirst));

                        while ((fileNameFirst = readerFileFirst.readLine()) != null) {

                            allLines.add(fileNameFirst);

                        }
                        BufferedReader readerFileSecond = new BufferedReader(new FileReader(fileNameSecond));

                        while ((fileNameSecond = readerFileSecond.readLine()) != null) {

                            forRemoveLines.add(fileNameSecond);
