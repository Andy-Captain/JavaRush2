...
public class AmigoOutputStream extends FileOutputStream{
    ...
    private FileOutputStream fosName;
    public AmigoOutputStream(FileOutputStream fosName) throws FileNotFoundException
    {
        super(fileName);
    ...
    public void write(byte[] b, int off, int len) throws IOException {
        fosName.write(b, off, len);
    }

    @Override
    public FileChannel getChannel() {
        return fosName.getChannel();
    }
