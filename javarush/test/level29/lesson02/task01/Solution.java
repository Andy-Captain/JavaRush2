...
public class Solution {
    ...
    public Solution(String firstFileName) {
        this.localFileName = firstFileName == null ? DEFAULT_FILE_NAME : firstFileName;
    }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Solution chekedForFile = new Solution(fileName);
        chekedForFile.downloadFileContent();
        if (chekedForFile.isFileLoaded()) {
            System.out.println(chekedForFile.hasFileExpectedLine("public class Solution {"));   //expected true
            System.out.println(chekedForFile.hasFileExpectedLine(" public class Solution {"));  //expected false
        }
    }
}
