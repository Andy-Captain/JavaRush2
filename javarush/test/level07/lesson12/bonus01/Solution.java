...
public class Solution
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        while (true)
        {
            ...
            String weih = reader.readLine();
            if (weih.isEmpty()) break;
            int weiht = Integer.parseInt(weih);

            String tai = reader.readLine();
            if (tai.isEmpty()) break;
            int tail = Integer.parseInt(tai);
